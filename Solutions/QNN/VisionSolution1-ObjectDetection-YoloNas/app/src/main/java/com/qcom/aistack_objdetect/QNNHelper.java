...
public class QNNHelper {
    ...
    public native String initQNN(AssetManager assetManager, String backend, String model_name,String nativeDirPath,String perf_profile); // added perfromance profile
     ...
     */
    public boolean loadingMODELS(String runtime_var, String dlc_name, String perf_profile) {
...
//        System.out.println("list--sumith:"+);
        ...
        String init_str = initQNN(assetManager, runtime_var, dlc_name,nativeDirPath,perf_profile); // added perfromance profile
