...
cp $SNPE_ROOT/lib/aarch64-android/libSnpeHtpV81Stub.so  ./SentimentAnalysis/app/src/main/jniLibs/arm64-v8a/.
...
cp $SNPE_ROOT/lib/hexagon-v81/unsigned/libSnpeHtpV81Skel.so ./SentimentAnalysis/app/src/main/jniLibs/arm64-v8a/.
...
[ -f "./SentimentAnalysis/app/src/main/jniLibs/arm64-v8a/libSnpeHtpV81Skel.so" ] && echo "True" || echo "Lib not found, please copy manually"
[ -f "./SentimentAnalysis/app/src/main/jniLibs/arm64-v8a/libSnpeHtpV81Stub.so" ] && echo "True" || echo "Lib not found, please copy manually"
